...
__webpack_require__.d(__webpack_exports__, {
  ensureMusicLoaded: () => (/* binding */ ensureMusicLoaded)
});
...
const isKnownMathMLAttr = /* @__PURE__ */ shared_esm_bundler_makeMap(
...
const normalizeRef = ({
  ...
  return ref != null ? isString(ref) || reactivity_esm_bundler_isRef(ref) || shared_esm_bundler_isFunction(ref) ? { i: currentRenderingInstance, r: ref, k: ref_key, f: !!ref_for } : ref : null;
};
...
const sharedState = reactive({
    music: {
        ...
        async getAllChatMessages() {
            ...
            // 检查是否有锁定歌曲
            await this.checkLockedSong();
            if (list.length > 0 && !this.lockedSong) {
                this.index = list.length - 1;
            }
        },
        async checkLockedSong() {
            const lastId = await triggerSlash('/pass {{lastMessageId}}');
            if (!lastId)
                return;
            const messages = await getChatMessages(`0-${lastId}`, { role: 'all' });
            // 从最新消息往前找，找到第一个锁定标签
            for (let i = messages.length - 1; i >= 0; i--) {
                const msg = messages[i].message;
                const lockMatches = [...msg.matchAll(this.lockRegex)];
                if (lockMatches.length > 0) {
                    const match = lockMatches[lockMatches.length - 1];
                    this.lockedSong = {
                        song: match[1],
                        singer: match[2],
                    };
                    console.log('锁定歌曲:', this.lockedSong);
                    return;
                }
            }
            // 如果没找到锁定标签，清除锁定
...
const _hoisted_1 = { class: "bg-effects" };
const _hoisted_2 = { class: "record-section" };
const _hoisted_3 = { class: "record-platter" };
const _hoisted_4 = { class: "record-surface" };
const _hoisted_5 = { class: "record-label" };
const _hoisted_6 = { class: "label-text" };
const _hoisted_7 = { class: "song-info-section" };
const _hoisted_8 = { class: "song-title" };
const _hoisted_9 = { class: "song-artist" };
const _hoisted_10 = { class: "lyrics-section" };
const _hoisted_11 = { class: "lyric-current" };
const _hoisted_12 = { class: "lyric-next" };
const _hoisted_13 = { class: "time-display" };
const _hoisted_14 = { class: "time-current" };
const _hoisted_15 = { class: "time-total" };
const _hoisted_16 = { class: "progress-track" };
const _hoisted_17 = ["max", "value"];
const _hoisted_18 = { class: "controls-row" };
const _hoisted_19 = ["title"];
const _hoisted_20 = ["title"];
const _hoisted_21 = { class: "volume-row" };
const _hoisted_22 = { class: "playlist-items" };
const _hoisted_23 = ["onClick"];
const _hoisted_24 = { class: "item-index" };
const _hoisted_25 = { class: "item-info" };
const _hoisted_26 = { class: "item-name" };
const _hoisted_27 = { class: "item-singer" };
const _hoisted_28 = {
    key: 0,
...
/* harmony default export */ const musicPlayervue_type_script_setup_true_lang_ts = (/*@__PURE__*/defineComponent({
    __name: 'musicPlayer',
    setup(__props) {
        ...
        const Music = globalThis.Music;
        const playlistItems = runtime_core_esm_bundler_computed(() => sharedState.music.list);
        const progressPercent = runtime_core_esm_bundler_computed(() => {
            if (!duration.value)
                return 0;
            return (currentTime.value / duration.value) * 100;
        });
        const modeIcon = runtime_core_esm_bundler_computed(() => {
            switch (playMode.value) {
                case 'repeat': return 'fas fa-redo';
                case 'repeat-one': return 'fas fa-redo fa-spin';
                case 'shuffle': return 'fas fa-random';
                default: return 'fas fa-redo';
            }
        });
        const modeLabel = runtime_core_esm_bundler_computed(() => {
            switch (playMode.value) {
        ...
        runtime_core_esm_bundler_watch(volume, newVal => {
            musicAudio.volume = newVal / 100;
        });
        // 监听锁定歌曲的变化
        runtime_core_esm_bundler_watch(() => sharedState.music.lockedSong, (lockedSong) => {
            if (lockedSong) {
                console.log('检测到锁定歌曲:', lockedSong);
                PlayLockedMusic(lockedSong);
            }
        });
        runtime_core_esm_bundler_watch(() => sharedState.music.index, (newVal, oldVal) => {
            console.log('index 变化:', oldVal, '->', newVal);
            // 如果有锁定歌曲，不响应普通播放列表的变化
            if (sharedState.music.lockedSong)
                return;
        ...
        function parseLyricToTimeline(lyric) {
        ...
        function updateLyricDisplayByTime(currentTimeVal) {
        ...
        function onEnded() {
            ...
            switch (playMode.value) {
                ...
                case 'repeat':
                    ...
                    break;
                case 'shuffle':
                    const randomIdx = Math.floor(Math.random() * playlistItems.value.length);
                    sharedState.music.index = randomIdx;
                    controlAction(null, 'play');
                    break;
                default:
                    if (sharedState.music.index >= playlistItems.value.length - 1) {
                        isPlaying.value = false;
                    }
                    else {
                        controlAction(null, 'next');
        ...
        async function controlAction(event, action) {
        ...
        function seekProgress(e) {
            ...
            musicAudio.currentTime = percent * duration.value;
        }
        function onProgressInput(e) {
            const target = e.target;
            musicAudio.currentTime = parseFloat(target.value);
        }
        ...
        // 播放锁定歌曲
        async function PlayLockedMusic(lockedSong) {
            const name = lockedSong.song;
            let playUrl = '';
            const cached = sharedState.music.cache[name];
            const cachedMeta = cached && typeof cached === 'object' ? cached : null;
            if (cached) {
            ...
            let fetchedMeta = null;
            if (!playUrl) {
                currentLine.value = '搜索锁定歌曲中...';
                nextLine.value = lockedSong.song;
                const result = await Music.SearchMusic(name);
                console.log('锁定歌曲搜索结果:', JSON.stringify(result));
                if (!result?.Url) {
                    currentLine.value = '锁定歌曲搜索失败';
                    nextLine.value = name;
                    return;
                }
                playUrl = result.Url;
            ...
            const meta = fetchedMeta || cachedMeta;
            if (meta) {
                currentSinger.value = meta.Singer || lockedSong.singer;
                currentSong.value = meta.Name || lockedSong.song;
                currentLyricStr.value = meta.Lyric || '';
            }
            else {
                currentSinger.value = lockedSong.singer;
                currentSong.value = lockedSong.song;
            }
            if (currentLyricStr.value) {
                parsedLyrics.value = parseLyricToTimeline(currentLyricStr.value);
                currentLyricIndex.value = -1;
            ...
            isPlaying.value = true;
            hasStarted.value = true;
            playingIndex.value = -1; // 锁定模式用 -1 表示
            // 自动切换到单曲循环模式
        ...
        function onDoubleClick(e) {
            if (hasMovedWhileDragging.value || isRightClick.value)
                return;
            e.stopPropagation();
        ...
        function savePosition() {
            ...
            localStorage.setItem('vinylPlayerPosition', JSON.stringify(position));
        }
        function restorePosition() {
            const el = widget.value;
            if (!el)
                return;
            const saved = localStorage.getItem('vinylPlayerPosition');
            if (saved) {
        ...
        function onVisibilityChange() {
            ...
            else if (el && isExpanded.value) {
                startHideTimer();
            }
        }
        function onDocumentClick(e) {
            if (isRightClick.value && !(e.target && e.target.closest && e.target.closest('.vinyl-player'))) {
                isRightClick.value = false;
            }
        }
        ...
        onMounted(() => {
            if (widget.value) {
                widget.value.addEventListener('touchmove', e => {
                    if (isDragging.value && !isRightClick.value) {
                        e.preventDefault();
                    }
                }, { passive: false });
        ...
        return (_ctx, _cache) => {
            return (openBlock(), createElementBlock("div", {
                ...
                ref_key: "widget",
                ref: widget,
                style: normalizeStyle(`top:${dragY.value};left:${dragX.value}`)
            }, [
                createCommentVNode(" 悬浮球 - 黑胶唱片 "),
                createBaseVNode("div", {
                    class: normalizeClass(["mini-vinyl", { spinning: isPlaying.value }])
                }, [...(_cache[8] || (_cache[8] = [
                        createBaseVNode("div", { class: "vinyl-record" }, [
                            createBaseVNode("div", { class: "vinyl-label" }),
                            createBaseVNode("div", { class: "vinyl-grooves" })
                        ], -1 /* CACHED */)
                    ]))], 2 /* CLASS */),
                createCommentVNode(" 展开后的随身听界面 "),
                createBaseVNode("div", {
                    class: normalizeClass(["walkman-container", { expanded: isExpanded.value }])
                }, [
                    createCommentVNode(" 背景特效 "),
                    ...
                    createCommentVNode(" 黑胶唱片区域 "),
                    createBaseVNode("div", _hoisted_2, [
                        createBaseVNode("div", {
                            class: normalizeClass(["tonearm", { playing: isPlaying.value }])
                        }, [...(_cache[9] || (_cache[9] = [
                                createBaseVNode("div", { class: "tonearm-base" }, null, -1 /* CACHED */),
                                createBaseVNode("div", { class: "tonearm-arm" }, null, -1 /* CACHED */),
                                createBaseVNode("div", { class: "tonearm-head" }, null, -1 /* CACHED */)
                            ]))], 2 /* CLASS */),
                        createBaseVNode("div", {
                            class: normalizeClass(["main-record", { spinning: isPlaying.value }])
                        }, [
                            createBaseVNode("div", _hoisted_3, [
                                createBaseVNode("div", _hoisted_4, [
                                    _cache[10] || (_cache[10] = createBaseVNode("div", { class: "record-center" }, null, -1 /* CACHED */)),
                                    createBaseVNode("div", _hoisted_5, [
                                        createBaseVNode("span", _hoisted_6, toDisplayString(currentSong.value || '黑胶唱片'), 1 /* TEXT */)
                                    ]),
                                    _cache[11] || (_cache[11] = createBaseVNode("div", { class: "record-grooves" }, null, -1 /* CACHED */))
                                ])
                            ])
                        ], 2 /* CLASS */)
                    ]),
                    createCommentVNode(" 歌曲信息 "),
                    createBaseVNode("div", _hoisted_7, [
                        createBaseVNode("div", _hoisted_8, toDisplayString(currentSong.value || '等待播放...'), 1 /* TEXT */),
                        createBaseVNode("div", _hoisted_9, toDisplayString(currentSinger.value || '歌手'), 1 /* TEXT */)
                    ]),
                    createCommentVNode(" 歌词显示 "),
                    createBaseVNode("div", _hoisted_10, [
                        createBaseVNode("div", _hoisted_11, toDisplayString(currentLine.value || '♪ 歌词 ♪'), 1 /* TEXT */),
                        createBaseVNode("div", _hoisted_12, toDisplayString(nextLine.value), 1 /* TEXT */)
                    ]),
                    ...
                    createBaseVNode("div", {
                        ...
                        createBaseVNode("div", _hoisted_13, [
                            createBaseVNode("span", _hoisted_14, toDisplayString(formatTime(currentTime.value)), 1 /* TEXT */),
                            createBaseVNode("span", _hoisted_15, toDisplayString(formatTime(duration.value)), 1 /* TEXT */)
                        ]),
                        createBaseVNode("div", {
                            ...
                            createBaseVNode("input", {
                                ...
                                style: normalizeStyle({ '--progress-fill': progressPercent.value + '%' })
                            }, null, 44 /* STYLE, PROPS, NEED_HYDRATION */, _hoisted_17)
                        ])
                    ]),
                    createCommentVNode(" 播放控制 "),
                    createBaseVNode("div", {
                        ...
                        createBaseVNode("div", _hoisted_18, [
                            createBaseVNode("button", {
                                class: normalizeClass(["ctrl-btn mode-btn", { active: playMode.value !== 'normal' }]),
                                onClick: toggleMode,
                                title: modeLabel.value
                            }, [
                                createBaseVNode("i", {
                                    class: normalizeClass(modeIcon.value)
                                }, null, 2 /* CLASS */)
                            ], 10 /* CLASS, PROPS */, _hoisted_19),
                            createBaseVNode("button", {
                                class: "ctrl-btn prev-btn",
                                onClick: _cache[2] || (_cache[2] = e => controlAction(e, 'prev')),
                                title: "上一首"
                            }, [...(_cache[12] || (_cache[12] = [
                                    createBaseVNode("i", { class: "fas fa-backward" }, null, -1 /* CACHED */)
                                ]))]),
                            createBaseVNode("button", {
                                class: "ctrl-btn play-btn",
                                onClick: _cache[3] || (_cache[3] = e => controlAction(e, isPlaying.value ? 'stop' : 'play')),
                            ...
                            createBaseVNode("button", {
                                ...
                                onClick: _cache[4] || (_cache[4] = e => controlAction(e, 'next')),
                                title: "下一首"
                            }, [...(_cache[13] || (_cache[13] = [
                                    createBaseVNode("i", { class: "fas fa-forward" }, null, -1 /* CACHED */)
                                ]))]),
                            createBaseVNode("button", {
                                ...
                                title: "播放列表"
                                    ...
                                    createBaseVNode("i", { class: "fas fa-list" }, null, -1 /* CACHED */)
                                ]))])
                        ]),
                        createCommentVNode(" 音量控制 "),
                        createBaseVNode("div", _hoisted_21, [
                            _cache[15] || (_cache[15] = createBaseVNode("i", { class: "fas fa-volume-down vol-icon" }, null, -1 /* CACHED */)),
                            withDirectives(createBaseVNode("input", {
                                type: "range",
                                class: "volume-slider",
                                min: "0",
                                max: "100",
                                "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => ((volume).value = $event)),
                                onClick: _cache[6] || (_cache[6] = withModifiers(() => { }, ["stop"])),
                                style: normalizeStyle({ '--volume-fill': volume.value + '%' })
                            }, null, 4 /* STYLE */), [
                                [vModelText, volume.value]
                            ]),
                            _cache[16] || (_cache[16] = createBaseVNode("i", { class: "fas fa-volume-up vol-icon" }, null, -1 /* CACHED */))
                        ])
                    ]),
                    createCommentVNode(" 播放列表 "),
                    createBaseVNode("div", {
                        class: normalizeClass(["playlist-container", { show: showPlaylist.value }])
                    }, [
                        createBaseVNode("div", { class: "playlist-header" }, [
                            _cache[18] || (_cache[18] = createBaseVNode("span", { class: "playlist-title" }, "播放列表", -1 /* CACHED */)),
                            createBaseVNode("button", {
                        ...
                        createBaseVNode("div", _hoisted_22, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(playlistItems.value, (item, idx) => {
                                return (openBlock(), createElementBlock("div", {
                                    key: idx,
                                    class: normalizeClass(["playlist-item", { playing: idx === playingIndex.value }]),
                                    onClick: ($event) => (playFromList(idx))
                                }, [
                                    createBaseVNode("span", _hoisted_24, toDisplayString(idx + 1), 1 /* TEXT */),
                                    createBaseVNode("span", _hoisted_25, [
                                        createBaseVNode("span", _hoisted_26, toDisplayString(item.song), 1 /* TEXT */),
                                        createBaseVNode("span", _hoisted_27, toDisplayString(item.singer), 1 /* TEXT */)
                                    ]),
                                    (idx === playingIndex.value)
                                        ? (openBlock(), createElementBlock("i", _hoisted_28))
                                        : createCommentVNode("v-if", true)
                                ], 10 /* CLASS, PROPS */, _hoisted_23));
                            }), 128 /* KEYED_FRAGMENT */)),
                            (playlistItems.value.length === 0)
                                ? (openBlock(), createElementBlock("div", _hoisted_29, " 暂无歌曲，请先在聊天中发送 BGM 信息 "))
                                : createCommentVNode("v-if", true)
                        ])
                    ], 2 /* CLASS */),
                    createCommentVNode(" 收起按钮 "),
                    createBaseVNode("button", {
                        class: "collapse-btn",
                        onClick: collapsePlayer,
                        title: "收起"
                    }, [...(_cache[19] || (_cache[19] = [
                            createBaseVNode("i", { class: "fas fa-chevron-down" }, null, -1 /* CACHED */)
                        ]))])
                ], 2 /* CLASS */)
...
// EXTERNAL MODULE: ./node_modules/.pnpm/vue-loader@17.4.2_vue@3.5.2_23bea212a99252ee9d5319df3c51d616/node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(958);
...
const __exports__ = /*#__PURE__*/(0,exportHelper["default"])(musicPlayervue_type_script_setup_true_lang_ts, [['__scopeId',"data-v-e10fa602"]])

/* harmony default export */ const musicPlayer = (__exports__);
...
async function eventHandle(eventType, message_id) {
    ...
    if (eventType == '消息生成完成') {
        ...
        for (const message of ChatMessages) {
            ...
            const matches = [...msgContent.matchAll(sharedState.music.regex)];
            const lockMatches = [...msgContent.matchAll(sharedState.music.lockRegex)];
            // 检查是否有锁定标签
            if (lockMatches.length > 0) {
                const match = lockMatches[lockMatches.length - 1];
                sharedState.music.lockedSong = {
                    song: match[1],
                    singer: match[2],
                };
                console.log('检测到锁定歌曲:', sharedState.music.lockedSong);
                continue;
            }
            if (matches.length == 0) {
                continue;
